package com.github.mekanismsuitsurvivalunits.registry;

import com.github.mekanismsuitsurvivalunits.SuitSurvivalUnits;
import com.github.mekanismsuitsurvivalunits.module.EmergencyRevivalModule;
import com.github.mekanismsuitsurvivalunits.module.PhaseGuardModule;
...
public final class MSSUModules {
    ...
    public static final DeferredRegister<ModuleData<?>> MODULES = DeferredRegister.create(MekanismAPI.MODULE_REGISTRY_NAME, SuitSurvivalUnits.MODID);
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(SuitSurvivalUnits.MODID);

    public static final DeferredItem<Item> PHASE_GUARD_ITEM = ITEMS.register("phase_guard_unit",
            () -> IModuleHelper.INSTANCE.createModuleItem(MSSUModules::phaseGuardHolder, new Item.Properties()));
    public static final DeferredItem<Item> CHAOS_ANCHOR_ITEM = ITEMS.register("chaos_anchor_unit",
            () -> IModuleHelper.INSTANCE.createModuleItem(MSSUModules::chaosAnchorHolder, new Item.Properties()));
    public static final DeferredItem<Item> EMERGENCY_REVIVAL_ITEM = ITEMS.register("emergency_revival_unit",
            () -> IModuleHelper.INSTANCE.createModuleItem(MSSUModules::emergencyRevivalHolder, new Item.Properties()));
    ...
    public static void register(IEventBus bus) {
        ...
        ITEMS.register(bus);
        bus.addListener(MSSUModules::addCreativeTabContents);
    }
